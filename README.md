  ...
  stages {
    ...
    stage('Record Coverage') {
      ...
      steps {
        ...
        step([$class: 'BranchCoverageAction', scmVars: [GIT_URL: env.GIT_URL, GIT_BRANCH: env.GIT_BRANCH]])
      }
    }
    stage('PR Coverage to Github') {
      ...
      steps {
        ...
        step([$class: 'CompareCoverageAction', publishResultAs: 'statusCheck', scmVars: [GIT_URL: env.GIT_URL, CHANGE_TARGET: env.CHANGE_TARGET]])
      }
    }
  }
}
